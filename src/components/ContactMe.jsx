...
import { FaReddit, FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaStackOverflow, FaGithub, FaAward} from "react-icons/fa";
...
<a href="https://www.credly.com/users/thasneem-chalil.9cb1d575" target="_blank" rel="noopener noreferrer">
  <FaAward style={{ color: "#FF6B00" }} className="icon" /> 
</a>
